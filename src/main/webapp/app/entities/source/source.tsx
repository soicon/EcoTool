...
export type ISourceState = IPaginationBaseState;

export class Source extends React.Component<ISourceProps, ISourceState> {
  state: ISourceState = {
  ...
  render() {
    const { sourceList, match, totalItems } = this.props;
    return (
      <div>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('device_id')}>
                  Device Id <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={this.sort('need_re_answer')}>
                  Need Re Answer <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('question_id')}>
                  Question Id <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {sourceList.map((source, i) => (
                <tr key={`entity-${i}`}>
                  <td>
                    <Button tag={Link} to={`${match.url}/select/${source.id}`} color="link" size="sm">
                      {source.id}
                    </Button>
                  </td>
                  <td>{source.path}</td>
                  ...
                  <td>{source.type}</td>
                  <td>{source.status}</td>
                  <td>{source.need_re_answer}</td>
                  <td>{source.question_id}</td>
