...
export type IQuestionState = IPaginationBaseState;
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('question_text')}>
                  Question Text <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('visible')}>
            ...
            <tbody>
              {questionList.map((question, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{question.sourceId ? <Link to={`source/${question.sourceId}`}>{question.sourceId}</Link> : ''}</td>
